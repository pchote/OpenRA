...
namespace OpenRA.Mods.Common.Widgets.Logic
{
	...
	public class IngameChatLogic : ChromeLogic
	{
		...
		public override void Tick()
		{
			...
			chatEnabled = Game.RunTime >= orderManager.ChatDisabledUntil && orderManager.ChatDisabledUntil != uint.MaxValue;
			...
			{
				var remaining = 0;
				if (orderManager.ChatDisabledUntil != uint.MaxValue)
					remaining = (int)(orderManager.ChatDisabledUntil - Game.RunTime + 999) / 1000;
