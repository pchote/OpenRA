...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class Bridge : IRender, INotifyDamageStateChanged, IRadarSignature, ITick
	{
		...
		bool initialized;
		readonly Dictionary<ushort, IRenderable[]>[] renderables = new Dictionary<ushort, IRenderable[]>[8];
