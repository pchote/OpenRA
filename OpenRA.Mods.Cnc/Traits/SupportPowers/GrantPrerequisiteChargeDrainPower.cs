...
namespace OpenRA.Mods.Cnc.Traits
{
	...
	public class GrantPrerequisiteChargeDrainPower : SupportPower, ITechTreePrerequisite, INotifyOwnerChanged
	{
		...
		{
			return new DischargableSupportPowerInstance(key, info, manager);
		}
		...
		public class DischargableSupportPowerInstance : SupportPowerInstance
		{
			...
			public DischargableSupportPowerInstance(string key, GrantPrerequisiteChargeDrainPowerInfo info, SupportPowerManager manager)
			...
			public override void Activate(Order order)
			{
				...
				Instances.First().PlayLaunchSounds();
