...
check:
	...
	@mono --debug bin/OpenRA.Utility.exe all --check-runtime-assemblies $(WHITELISTED_OPENRA_ASSEMBLIES) $(WHITELISTED_THIRDPARTY_ASSEMBLIES) $(WHITELISTED_CORE_ASSEMBLIES)
	@echo
	@echo "Checking for explicit interface violations..."
	@mono --debug bin/OpenRA.Utility.exe all --check-explicit-interfaces
	@echo
	@echo "Checking for incorrect conditional trait interface overrides..."
	@mono --debug bin/OpenRA.Utility.exe all --check-conditional-trait-interface-overrides

test: core
	@echo
	@echo "Testing Tiberian Sun mod MiniYAML..."
	@mono --debug bin/OpenRA.Utility.exe ts --check-yaml
	@echo
	@echo "Testing Dune 2000 mod MiniYAML..."
	@mono --debug bin/OpenRA.Utility.exe d2k --check-yaml
	@echo
	@echo "Testing Tiberian Dawn mod MiniYAML..."
	@mono --debug bin/OpenRA.Utility.exe cnc --check-yaml
	@echo
	@echo "Testing Red Alert mod MiniYAML..."
	@mono --debug bin/OpenRA.Utility.exe ra --check-yaml
...
install-man-page:
	...
	@mono --debug bin/OpenRA.Utility.exe all --man-page > openra.6
