	...
	sealed class Texture : ThreadAffine, ITexture
	{
		...
		public void SetData(Bitmap bitmap)
		{
			...
			try
			{
				...
				PrepareTexture();
				OpenGL.glTexImage3D(OpenGL.GL_TEXTURE_2D_ARRAY, 0, OpenGL.GL_RGBA8, bits.Width, bits.Height, 1,
		...
		public byte[] GetData()
		{
			...
			unsafe
			{
				...
				{
					var intPtr = new IntPtr((void*)ptr);
					OpenGL.glGetTexImage(OpenGL.GL_TEXTURE_2D_ARRAY, 0, OpenGL.GL_BGRA,
