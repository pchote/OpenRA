...
namespace OpenRA.Mods.RA
{
	...
	class Crate : ITick, IPositionable, ICrushable, ISync, INotifyParachuteLanded, INotifyAddedToWorld, INotifyRemovedFromWorld
	{
		...
		public void SetPosition(Actor self, WPos pos) { SetPosition(self, self.World.CellContaining(pos)); }
		public void SetVisualPosition(Actor self, WPos pos) { SetPosition(self, self.World.CellContaining(pos)); }
