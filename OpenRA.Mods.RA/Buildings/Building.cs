...
namespace OpenRA.Mods.RA.Buildings
{
	...
	public class BuildingInfo : ITraitInfo, IOccupySpaceInfo, UsesInit<LocationInit>
	{
		...
		{
			var center = world.CenterOfCell(topLeft) + FootprintUtils.CenterOffset(world, this);
	...
	public class Building : INotifyDamage, IOccupySpace, INotifyCapture, INotifyBuildComplete, INotifySold, ISync, ITechTreePrerequisite, INotifyAddedToWorld, INotifyRemovedFromWorld
	{
		...
		public Building(ActorInitializer init, BuildingInfo info)
		{
			...
			CenterPosition = init.world.CenterOfCell(topLeft) + FootprintUtils.CenterOffset(init.world, Info);
