...
namespace OpenRA.Mods.RA.Move
{
	class Move : Activity
	{
		...
		public override Activity Tick(Actor self)
		{
			...
			var firstFacing = self.World.FacingBetween(mobile.fromCell, nextCell.Value.First, mobile.Facing);
			...
			else
			{
				...
				var move = new MoveFirstHalf(
					this,
					self.World.CenterOfCell(mobile.fromCell) + MobileInfo.SubCellOffsets[mobile.fromSubCell],
		...
		class MoveFirstHalf : MovePart
		{
			...
			protected override MovePart OnComplete(Actor self, Mobile mobile, Move parent)
			{
				...
				if (nextCell != null)
				{
					if (IsTurn(mobile, nextCell.Value.First))
					{
						...
						var ret = new MoveFirstHalf(
							...
							mobile.Facing,
							Util.GetNearestFacing(mobile.Facing, self.World.FacingBetween(mobile.toCell, nextCell.Value.First, mobile.Facing)),
							moveFraction - moveFractionTotal);
				...
				var ret2 = new MoveSecondHalf(
					move,
					Util.BetweenCells(self.World, mobile.fromCell, mobile.toCell) + (fromSubcellOffset + toSubcellOffset) / 2,
					self.World.CenterOfCell(mobile.toCell) + toSubcellOffset,
					mobile.Facing,
					mobile.Facing,
					moveFraction - moveFractionTotal);
